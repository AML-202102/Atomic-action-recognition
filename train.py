...
def main():
    ...
    parser.add_argument('--train_label', type=str, default='annotations/RobotSegSantaFe_v2_fold1.json', help='train label path.')
    parser.add_argument('--test_label', type=str, default='annotations/RobotSegSantaFe_v2_fold1.json', help='test label path.')
